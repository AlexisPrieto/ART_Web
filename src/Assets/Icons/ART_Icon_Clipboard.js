...
const SVG = ({
  ...
  >
    <path fill={fill} d="M21.945,6.06V5.359c0-0.796-0.646-1.441-1.441-1.441h-2.365c0.197-0.356,0.309-0.797,0.309-1.245
			...
			L25.156,28.492z"/>
		<circle fill={fill} cx="10.852" cy="13.098" r="1.899"/>
		<path fill={fill} d="M21.656,12.038H15.18c-0.596,0-1.08,0.475-1.08,1.071c0,0.596,0.483,1.071,1.08,1.071h6.478
			c0.596,0,1.078-0.475,1.078-1.071C22.736,12.513,22.253,12.038,21.656,12.038z"/>
		<circle fill={fill} cx="10.852" cy="18.485" r="1.899"/>
		<path fill={fill} d="M21.656,17.391H15.18c-0.596,0-1.08,0.498-1.08,1.094s0.483,1.092,1.08,1.092h6.478c0.596,0,1.078-0.496,1.078-1.092
			S22.253,17.391,21.656,17.391z"/>
		<circle fill={fill} cx="10.852" cy="24.242" r="1.898"/>
		<path fill={fill} d="M21.656,23.145H15.18c-0.596,0-1.08,0.498-1.08,1.094s0.483,1.092,1.08,1.092h6.478c0.596,0,1.078-0.497,1.078-1.092
