...
import DENUNCIASI from '../../Assets/Img/DENUNCIA.jpg';
import { Link } from "react-router-dom";
import Icon from "../../Assets/Icons/ART_Icon_Download";

export class Denuncias extends Component {
        ...
        return (
            <div className="">
                ...
                <div className="container" style={{display: 'inline-flex'}} >
                    <p className="container denuncias">
                        <img src={DENUNCIASI}/>    
                        
                    </p>

                    <div style={{ 'margin-bottom': '15%', 'place-self': 'flex-end'}}>
                        <div style={{display: 'inline-flex', marginBottom: '10%', display: 'inline-flex', float: 'left'}}>
   
                            <Link  to={"Download/PRESTACIONES/Formulario Denuncia de Accidente Laboral.pdf"}
                                download
                                target="_blank"
                                style={{zoom: '67%'}}>
                            ...
                            <div>Denuncia de Accidente Laboral   </div>
                        </div>

                        <div style={{display: 'inline-flex', display: 'inline-flex', float: 'left'}}>
                           
                            <Link   to={"Download/PRESTACIONES/Formulario Denuncia de Enfermedad Profesional.pdf"}
                                download
                                target="_blank"
                                style={{zoom: '67%'}}>
                                <Icon fill="#F8A700" width={50}/>
                            ...
                            <div>Denuncia de Enfermedad Profesional </div>
                        </div>
                    </div>
                </div>
            </div>
