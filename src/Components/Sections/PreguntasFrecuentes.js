      ...
      <div className={classes.root} className="container">
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelSummary
            expandIcon={<ExpandMoreIcon style={{color: '#F8A700'}}/>}
            style={{'border-bottom': 'solid','border-bottom-color': '#F8A700'}}
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            Las Aseguradoras de Riesgo de Trabajo son Compañías de Seguros que tendrán como objeto único el otorgamiento de las prestaciones que establece la ley.<p/>
            La autorización para funcionar como ART estará a cargo de la SRT (Superintendencia de Riesgos de Trabajo) y la SSN (Superintendencia de Seguros de la Nación). Esta autorización podrá ser revocada por:<p/>
            <ul>
              <li>a) Omisión de otorgamiento íntegro y oportuno de las prestaciones de la ley.</li>
              <li>b) Cuando se verifiquen deficiencias graves en el cumplimiento de su objeto que no sean subsanadas en los plazos que establezca la reglamentación expedida por SSN.</li>
              <li>c) Por causas y procedimientos previstos en la LRT (Ley de Riesgos del Trabajo) y en la ley 20.091 (Ley de Seguros), como por ejemplo pérdida del capital mínimo, liquidación de la casa matriz, etc.</li>
            </ul>
            Los bienes que respaldan las reservas de las ART son inembargables por cualquier crédito que no sea derivado de las obligaciones que establece la LRT, aún en caso de liquidación de la entidad. En este último caso los bienes serán transferidos al Fondo de Reserva, fondo que se ha creado con el fin de afrontar las prestaciones dinerarias y en especie de las ART en liquidación. <p/>
            Ley N° 24.557
            </Typography>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            Un accidente de trabajo es todo acontecimiento súbito y violento, ocurrido por el hecho o en ocasión del trabajo, o en el trayecto entre el domicilio del trabajador y su lugar de trabajo (y viceversa), siempre y cuando no lo hubiese interrumpido o alterado por causas ajenas al trabajo.<p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            <ul>
              <li>a) La reducción de la siniestralidad laboral a través de la asistencia técnica y el asesoramiento al empleador en el cumplimiento de sus obligaciones en materia de prevención de los riesgos derivados del trabajo.</li>
              <li>b) La reparación de los daños derivados de accidentes de trabajo y de enfermedades profesionales, incluyendo la rehabilitación del trabajador damnificado.</li>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            Son entidades asociativas de seguros mutuos sin fines de lucro, constituidas por las asociaciones profesionales de empleadores o grupos de empleadores y las asociaciones sindicales de trabajadores con personería gremial. Decreto N° 1720/12.
            </Typography>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel 
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            La alícuota se declara e ingresa durante el mes en que se brinden las prestaciones, con las mismas modalidades, plazos y condiciones establecidos para el pago de los aportes y contribuciones con destino a la seguridad social, en función de la nómina salarial del mes anterior.<p/>
            Con respecto a los empleadores no obligados con el Sistema único de Seguridad Social (SUSS), las cotizaciones se abonan bajo las mismas condiciones, directamente a las aseguradoras.<p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            El valor a abonar mensualmente, se conforma por un componente FIJO (cápita) por empleado bajo relación de dependencia y uno VARIABLE (prima) aplicable sobre el monto de la masa salarial imponible de todos los empleados.<p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            Todas las altas, bajas y modificaciones realizadas mediante el aplicativo Mi Simplificación, son incluidas en la nómina de su empresa mediante un proceso automático, el día hábil siguiente a partir de las 12 hs. por lo que no es necesario que la empresa cliente las informe a ART MUTUAL RURAL.<p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            Para consultar rápidamente el estado de su Contrato Tipo de Afiliación, ponemos a disposición RURAL MUTUA ART, una herramienta que le permitirá ver el detalle de cuotas, períodos devengados, alícuotas, premios, pagos, intereses y saldos de períodos adeudados, ingresando a nuestra   
            <a href="http://artmutualrural.org.ar" style={{color:'blue','text-decoration': 'underline' }} target="_blank"> página web</a>.<p/>
            ...
            Asimismo, Ud. podrá evacuar las consultas de facturación y cobranzas a través de los siguientes medios de contacto:<br/>
            	Enviando un e-mail a facturacion@artmutualrural.org.ar <br/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelSummary
            ...
            id="panel15bh-header"
          >
            <Typography className={classes.heading}>¿Cuáles son los exámenes médicos laborales obligatorios?</Typography>
            {/*<Typography className={classes.secondaryHeading}></Typography>*/}
          </ExpansionPanelSummary>
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            ...
            <ul>
              ...
              <li>	Los contenidos de estos exámenes serán, como mínimo, los del Anexo I de la Resolución 37/10.</li>
              <li>	En caso de preverse la exposición a los agente de riesgo del Decreto 658/96 deberán, además, efectuarse los estudios correspondientes a cada agente, detallados en el ANEXO II.</li>
            </ul>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            De acuerdo a la Resolución 37/10, los exámenes previos a la transferencia de actividad:<p/>
            <ul>
            ...
            <ul>
              ...
              <li>	La realización de estos exámenes, de carácter optativo, será responsabilidad de la Aseguradora sin perjuicio de que la Aseguradora pueda convenir con el empleador su realización.</li>
            </ul>
            ...
            <ul>
              ...
              <li>	Revisten el carácter de obligatorios en todos los casos en que exista exposición a los agentes de riesgo antes mencionados, debiendo efectuarse con las frecuencias y contenidos mínimos indicados en el ANEXO II de la Resolución 37/10, incluyendo un examen clínico.</li>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            Según el Art. 14 del Decreto 1338/96, quedan exceptuadas de la obligación de tener asignación de profesionales técnicos en higiene y seguridad las siguientes entidades:<p/>
            <ul>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            Si por algún motivo excepcional un trabajador accidentado hubiera recibido asistencia por fuera de la red de prestadores y éstos fueran autorizados o reconocidos por RURAL MUTUA ART, para solicitar su reintegro deberá: <p/>
            <ul>
              <li>Integrar todos los datos requeridos en el <a href="http://www.artmutualrural.org.ar/DESCARGAS" style={{color:'blue','text-decoration': 'underline' }} target="_blank">Formulario de Solicitud de Reintegro.</a></li>
            ...
            <ul>
              ...
              <li>La documentación completa deberá ser remitida a San Martín 588 – 5to piso, (1004), Ciudad Autónoma de Buenos Aires, Argentina 588 5to piso, Ciudad Autónoma de Buenos Aires, colocando en el sobre "Solicitud de Reintegro de Gastos Médicos" At: Liquidación de Prestaciones Médicas ART e indicando remitente.</li>
            </ul>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            <ul>
              <li>Incapacidad laboral temporaria. ILT. Se produce cuando un trabajador se encuentra accidentado o padece una enfermedad profesional, y el daño sufrido le impide la realización de sus tareas habituales.</li>
              <li>Incapacidad laboral permanente. ILP. Es la situación en que luego de haber estado sometido a tratamiento médico por la mutual, el trabajador presenta una disminución de su capacidad laboral de forma permanente. Cuando la incapacidad permanente es menor a 66%, se considera de grado parcial y cuando la incapacidad permanente es mayor o igual a 66%, es de grado total.</li>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            La Incapacidad Laboral Temporaria (ILT) se produce cuando un trabajador se encuentra accidentado o padece una enfermedad profesional y el daño sufrido le impide la realización de sus tareas habituales. Se trata de un impedimento transitorio que tiene una duración máxima de 24 meses contados desde la producción del accidente, o desde la primera manifestación invalidante (PMI) de la enfermedad.<p/>
            La Ley de Riesgos del Trabajo N° 24.557 establece cuatro causas por las cuales cesa la situación de ILT 1- Alta médica 2- Determinación de incapacidad laboral permanente 3- Transcurso de un año desde la PMI 4- Muerte del trabajador<p/>
            ...
            Durante los diez primeros días, contados a partir del día siguiente de la fecha de primera manifestación invalidante, el pago de la incapacidad laboral temporaria está a cargo del empleador. A partir del día undécimo está a cargo de la A.R.T.<p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            <Typography className={classes.desc} color="textSecondary">
            La prestación dineraria durante una Incapacidad Laboral Temporaria se calcula conforme a las pautas dispuestas por el artículo 208 de la Ley de Contrato de Trabajo N° 20.744 y sus modificatorias, incluye la totalidad de los conceptos que debió percibir el damnificado al momento de la primera manifestación invalidante, sin tener en cuenta el tope máximo de remuneraciones sujetas a aportes que estipula la ley previsional. <p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            El empleador deberá efectuar los pagos al trabajador de acuerdo a su periodicidad habitual de liquidación y efectuar las correspondientes Contribuciones Patronales y Retenciones. Para solicitar el reintegro, el empleador deberá completar y enviar la documentación detallada en el instructivo de reintegros de ILT que se encuentra publicado en <a href="http://www.artmutualrural.org.ar/DESCARGAS" style={{color:'blue','text-decoration': 'underline' }} target="_blank">ART MUTUAL RURAL</a><p/>
            RURAL MUTUA ART procederá al reintegro de dichas sumas dentro de los treinta (30) días contados a partir de la fecha en que se recibe la documentación completa.<p/>
            La documentación correspondiente se podrá enviar a nuestra casilla siniestros@artmutualrural.org.ar o enviar por correo a ART Mutual Rural - San Martín 588 – 5to piso, (1004), Ciudad Autónoma de Buenos Aires, Argentina.<p/>
        ...
        <ExpansionPanel 
          ...
          <ExpansionPanelDetails className={classes.desc}>
            ...
            <ul>
              ...
              <li>Copia de los recibos de sueldo de los 6 meses anteriores al mes del accidente, y recibo de liquidación final. En caso de que el siniestro haya ocurrido el mismo mes de inicio de la relación laboral o el accidentado tenga menos de 6 meses de antigüedad, deberá adjuntar el recibo del mes del accidente.</li>
              <li>Si el trabajador realiza trabajos de temporada o eventuales deberá presentar recibo de ajuste de producción y un detalle donde quede perfectamente detallado inicio y fin del periodo de trabajo en donde ocurrió el accidente.</li>
