...
export class Nosotros_Mision extends Component {
    render() {
        return (
            <div style={{padding: '3% 6%'}} >
                ...
                <p>
                    •	Compromiso: con el trabajo orientado hacia el progreso permanente y la satisfacción de nuestros clientes.<br/>
                    •	Respeto: atendiendo con cortesía, actitud de servicio y eficiencia los requerimientos que nos sean solicitados.<br/>
                    •	Integridad: asumimos una conducta honesta, transparente, coherente y austera.<br/>
                    •	Eficiencia: hacemos las cosas de manera prolija y correcta.<br/>
                </p>
            </div>
        )
    }
...
export default Nosotros_Mision
